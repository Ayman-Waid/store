README de l'Application Point de Vente

Il s'agit d'une application Point de Vente (POS) développée en Java à l'aide de l'IDE NetBeans.
L'application est conçue pour être utilisée par les petites et moyennes entreprises pour gérer leurs ventes et leur inventaire.
